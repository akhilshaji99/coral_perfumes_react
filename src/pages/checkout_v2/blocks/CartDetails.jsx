  ...
  return (
    <div className="col-lg-4 col-md-5">
      <div className=" card checkout-right-code">
        ...
        <h5 className="mb-4 bg-transparent">5 ITEMS</h5>
          ...
          <li className="list-group-item py-3 ps-0">
            <div className="row align-items-center d-flex justify-content-space-between">
              <div className="col-4 col-xs-2 col-lg-2 col-md-3 cart-details-img">
                <img
                  src="https://coralperfumes.cloud6.ae//media/product/Coral-Omega-Eau-De-Parfum-100Ml.png"
                  alt="Ecommerce"
                />
              </div>
              <div className="col-8 col-lg-8 col-xs-8 col-md-8 ">
                <h4 className="mb-0">Omega Eau De Parfum 100ML - Coral</h4>
                <h6 className="mb-0">
                  AED 55 <span>AED 125</span>
                </h6>
                <span style={{ textDecoration: "none" }}>Qty:</span> 15
              </div>
            </div>
          </li>
        </ul>
              ...
              <ul className="list-group list-group-flush mob-flush">
                <li className="list-group-item ps-0 border-0  d-flex justify-content-between align-items-start">
                  <div className="me-auto">
                    <div className="left-sec-text">Subtotal</div>
                  </div>
                  <span>
                    <h5>AED 1294</h5>
                  </span>
                ...
                <li className="list-group-item  ps-0 border-0  d-flex justify-content-between align-items-start">
                  <div className="me-auto">
                    <div className="left-sec-text">Shipping</div>
                  </div>
                  <span>Free</span>
                </li>
                <li className="list-group-item ps-0 border-0  d-flex justify-content-between align-items-start">
                  <div className="me-auto">
                    <div className="left-sec-text">Discount</div>
                  </div>
                  <span className="left-sec-text">AED 0.00</span>
                </li>
